      ...
      {categories.map((category) => {
        ...
        return (
          <button
            ...
            className={`
                group relative flex items-center text-xs md:text-xl uppercase tracking-wider transition-all duration-300 font-calistoga whitespace-nowrap cursor-pointer
